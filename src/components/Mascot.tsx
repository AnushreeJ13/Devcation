    ...
    <div className="mascot" id="mascot">
      <div className="mascot-visual">
        ...
        >
          ...
          <circle cx="161" cy="144" r="1.5" fill="white" opacity="0.8" />
          {/* Left antler */}
          ...
          <text x="170" y="197" textAnchor="middle" fontSize="7" fill="white" fontFamily="monospace" fontWeight="bold">DEL</text>
          {/* Glow dots */}
